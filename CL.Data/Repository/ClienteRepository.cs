...
namespace CL.Data.Repository
{
    public class ClienteRepository : IClienteRepository
    {
        ...
        {
            return await context.Clientes.AsNoTracking().ToListAsync(); // AsNoTracking = ganho de performance
        }

        public async Task<Cliente> GetClienteAsync(int Id_Cliente) // Método de retorno de clientes por Id
        {
            ...
            return await context.Clientes.FindAsync(Id_Cliente); // Não precisa da função lambda
        }
        ...
        {
            var clienteConsultado = await context.Clientes.FindAsync(cliente.Id_Cliente);
