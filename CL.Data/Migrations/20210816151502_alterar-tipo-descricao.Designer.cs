...
namespace CL.Data.Migrations
{
    ...
    [Migration("20210816151502_alterar-tipo-descricao")]
    partial class alterartipodescricao
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CL.Core.Domain.Funcao", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("FuncaoUsuario", b =>
                {
                    b.HasOne("CL.Core.Domain.Funcao", null)
                        .WithMany()
                        .HasForeignKey("FuncoesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CL.Core.Domain.Usuario", null)
                        .WithMany()
